...
### AIflow CLI
```bash
AIflow install github.com/r2d2-ai/ai-box/common/activity/kafka
```
...
The below example sends `Hello From AIflow` to a Kafka Broker running on localhost:
...
```json
{
  ...
  "activity": {
    "ref": "github.com/r2d2-ai/ai-box/common/activity/kafka",
    "settings": {
