...
import (
	...
	_ "github.com/r2d2-ai/aiflow/action/microgateway/internal/function"

	"github.com/r2d2-ai/aiflow/action"
	"github.com/r2d2-ai/aiflow/action/microgateway/api"
	"github.com/r2d2-ai/aiflow/action/microgateway/internal/core"
	"github.com/r2d2-ai/aiflow/action/microgateway/internal/schema"
...
func (f *Factory) Generate(settingsName string, imports *Imports, config *action.Config) (code string, err error) {
	...
	port := imports.Ensure("github.com/r2d2-ai/aiflow/action/microgateway/api")
