...
import (
	...
	sampleAction "github.com/r2d2-ai/aiflow/examples/action"
	sampleTrigger "github.com/r2d2-ai/aiflow/examples/trigger"
...
func (ind *IndependentAction) Ref() string {
	return "github.com/r2d2-ai/aiflow/examples/action"
}
